...
def parse_args():
    ...
    parser.add_argument('--env-id', type=str, default='PR2_Cube_cont-v0')
...
if __name__ == '__main__':
    ...
    if MPI.COMM_WORLD.Get_rank() == 0:
        logger.configure(dir=osp.join("/home/hermannl/master_thesis/git/baselines_private/baselines/ddpg/logs/",
